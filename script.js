...
// console.log(Math.random(seattle.maxCustomers * seattle.minCustomers));
const hours5 = ['7am', '8am', '9am', '10am', '11am', '12pm', '1pm', '2pm', '3pm', '4pm', '5pm', '6pm', '7pm'];

let cookieContainer5 = document.getElementById('cookies-sold'); // this is where my div container is

let ul5 = document.createElement('ul'); //unordered list
...
let totalDailyCookies5 = this.customersPerHour + this.CookiesPerHour;
